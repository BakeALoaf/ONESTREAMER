...
ActiveRecord::Schema[7.0].define(version: 2022_12_07_102354) do
  ...
  create_table "favourite_platforms", force: :cascade do |t|
    t.bigint "user_id", null: false
    t.bigint "platform_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["platform_id"], name: "index_favourite_platforms_on_platform_id"
    t.index ["user_id"], name: "index_favourite_platforms_on_user_id"
  end
